...
curl http://tinc-vpn.org/packages/tinc-1.0.34.tar.gz | tar xzC /tmp && \
cd /tmp/tinc-1.0.34 && ./configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var && make && make install && \
